...
var fx = (function () {
  ...
  function y(a) {
    ...
    a = a[8];
    var f =
      d * l * a - d * n * m - c * g * a + c * n * p + e * g * m - e * l * p;
    return [
      (l * a - n * m) / f,
      (e * m - c * a) / f,
      (c * n - e * l) / f,
  ...
  function L(b) {
    ...
    f.call(this, a.noise, { amount: q(0, b, 1) });
    return this;
  }
  function M(b) {
    a.sepia =
    ...
    f.call(this, a.sepia, { amount: q(0, b, 1) });
    return this;
  }
  function N(b, d) {
    a.unsharpMask =
    ...
    f.call(this, a.unsharpMask, { strength: d });
  ...
  function O(b) {
    ...
    f.call(this, a.vibrance, { amount: q(-1, b, 1) });
    return this;
  }
  function P(b, d) {
    a.vignette =
    ...
    f.call(this, a.vignette, { size: q(0, b, 1), amount: q(0, d, 1) });
    return this;
  }
  function Q(b, d, c) {
    a.lensBlurPrePass =
    ...
    a.lensBlur1 =
      ...
      new h(
        null,
        e + "void main(){gl_FragColor=(sample(delta0)+sample(delta1))*0.5;}"
      );
    a.lensBlur2 =
      a.lensBlur2 ||
      new h(
  ...
  function S(b) {
    ...
    f.call(this, a.triangleBlur, { delta: [b / this.width, 0] });
    f.call(this, a.triangleBlur, { delta: [0, b / this.height] });
    return this;
  }
  function T(b, d, c) {
    a.zoomBlur =
  ...
  function W(b) {
    ...
    f.call(this, a.edgeWork1, { delta: [b / this.width, 0] });
    f.call(this, a.edgeWork2, { delta: [0, b / this.height] });
    return this;
  }
  function X(b, d, c) {
    a.hexagonalPixelate =
  ...
  (function () {
    ...
    if (
      g &&
      -1 === g.getSupportedExtensions().indexOf("OES_texture_float_linear") &&
      a(g)
    ) {
      ...
      for (var e in b)
        if (b.hasOwnProperty(e)) {
          ...
          if (null !== c) {
            ...
            else if ("[object Number]" == Object.prototype.toString.call(d))
              a.uniform1f(c, d);
            else
              throw (
  ...
  z.prototype.interpolate = function (a) {
    ...
    return (
      g * this.ya[d] +
      a * this.ya[c] +
      (((g * g * g - g) * this.y2[d] + (a * a * a - a) * this.y2[c]) * e * e) /
        6
    );
  };
  var r = (function () {
